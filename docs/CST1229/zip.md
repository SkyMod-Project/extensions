...
The Zip extension allows you to read, create and edit .zip format files, including Scratch project and sprite files (.smp, .sprite3). 
...
```
 Opens a .zip (or .smp or .sprite3...) file.
